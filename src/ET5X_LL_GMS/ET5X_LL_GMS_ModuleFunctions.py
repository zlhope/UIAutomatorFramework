# ----------------------------------------------------------------------------------------------------------------------
# Name Of File: ET5X_LL_GMS_ModuleFunctions.py                                                                                #
# Author: Ashish Kumar                                                                                                 #
...
import unittest
import time
import ET5X_LL_GMS_Config
import ModuleFunctions
Config=ET5X_LL_GMS_Config.Config()
...
# ----------------------------------------------------------------------------------------------------------------------
    def takePicture(self, repetition=1):
        ...
        try:
            ...
            #Open the camera
            if not self.unit.launchApp(Config.CameraApp['text'],True):
...
# ----------------------------------------------------------------------------------------------------------------------
    def connectToWiFi(self,APName,APpassword):
        try:
            ...
            if not self.unit.launchApp(Config.SettingApp['text'],True):
